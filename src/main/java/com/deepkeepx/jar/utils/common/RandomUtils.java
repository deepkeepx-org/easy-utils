...
public class RandomUtils {
	 ...
	 *
	 * @return a 6-digit string composed of random numbers
	 */
	 ...
	 * Generate a string of random numbers
	 *
	 * @param length the minimum value
	 * @return a specified length string composed of random numbers
	 */
	...
	public static String chineseName() {
		return chineseName(true, 3);
	}
	
	/**
	 * Generate a chinese name
	 *
	 * @param simple whether to use simple or traditional characters
	 * @param len is chinese name length
	 * @return a chinese name
	 */
	public static String chineseName(boolean simple, int len) {
		String surName[] = {
